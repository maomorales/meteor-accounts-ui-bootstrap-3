(function() {
    ...
    Accounts._loginButtons.validateUsername = function(username) {
        if (username.length >= 3) {
            ...
            loginButtonsSession.errorMessage("El usuario debe tener al menos 3 caracteres de longitud");
            return false;
        }
    };
    Accounts._loginButtons.validateEmail = function(email) {
        ...
        if (re.test(email)) {
            ...
            loginButtonsSession.errorMessage("Email inválido");
            return false;
        }
    };
    Accounts._loginButtons.validatePassword = function(password) {
        if (password.length >= 6) {
            ...
            loginButtonsSession.errorMessage("El password debe tener al menos 6 caracteres de longitud");
            return false;
        }
    };
